export enum CanonType {
	...
	game = "Video Game",
	book = "Novel",
	youngAdultNovel = "Young Adult Novel",
...
export function formatTimeline(timelineArg: number): string {
...
const shows: CanonEntry[] = [
	...
	},
	{
		mediaLink: "https://www.disneyplus.com/series/the-mandalorian/3jLIGMDYINqD",
		era: CanonEra.newRepublic,
		name: "The Mandalorian S02",
		released: new Date("2020-10-30 10:00:00Z"),
		timeline: 10,
		type: CanonType.show,
		wookieepedia: "https://starwars.fandom.com/wiki/The_Mandalorian",
	},
	{
		mediaLink: "https://www.disneyplus.com/series/the-mandalorian/3jLIGMDYINqD",
		era: CanonEra.newRepublic,
		name: "The Mandalorian S03",
		released: new Date("2023-03-01 10:00:00Z"),
		timeline: 12,
		type: CanonType.show,
		wookieepedia: "https://starwars.fandom.com/wiki/The_Mandalorian",
	},
	...
	},
	{
		...
		era: CanonEra.empire,
		name: "Rebels S01",
		released: new Date("2014-10-03 10:00:00Z"),
		timeline: -5,
		type: CanonType.show,
	...
	},
	{
		...
		era: CanonEra.empire,
		name: "Rebels S02",
		released: new Date("2015-06-20 10:00:00Z"),
		timeline: -4,
		type: CanonType.show,
		wookieepedia: "https://starwars.fandom.com/wiki/Star_Wars_Rebels",
	},
	{
		...
		era: CanonEra.empire,
		name: "Rebels S03",
		released: new Date("2016-09-24 10:00:00Z"),
		timeline: -2.1,
		type: CanonType.show,
		wookieepedia: "https://starwars.fandom.com/wiki/Star_Wars_Rebels",
	},
	...
	},
	{
		...
		era: CanonEra.firstOrder,
		name: "Resistance S02",
		released: new Date("2019-10-06 10:00:00Z"),
		timeline: 34.2,
		type: CanonType.show,
		wookieepedia: "https://starwars.fandom.com/wiki/Star_Wars_Resistance",
	},
...
const highRepublic: CanonEntry[] = [
	...
	},
	{
		timeline: -382.7,
		era: CanonEra.highRepublic,
		type: CanonType.youngAdultNovel,
		wookieepedia:
